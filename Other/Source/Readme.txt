...
user in an INI file next to SpaceSnifferPortable.exe called SpaceSnifferPortable.ini.
...
copy AppNamePortable.ini from this directory to SpaceSnifferPortable.ini next to
SpaceSnifferPortable.exe. The options in the INI file are as follows:
